...
public interface ITransactionService
{
    ...
    Task<Result<IReadOnlyList<TransactionModel>>> GetTransactionsByCategoryAsync(string accountId, string categoryId, int page, int pageSize, CancellationToken token = default);
